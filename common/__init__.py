...
Pulled out of the v2 project's per-script duplication (auto batch-sizing,
checkpoint/resume, telemetry, seeding, CLI logging, ONNX export) into one
place each, per the v3 modularization pass — see v3_CHANGELOG.md for the
reasoning and file-by-file diff summary.
