...
blocks. Same architecture and hyperparameters as v4_mnist_digit_adamw_64.py
...
already returns — the same pattern v4_mnist_digit_soap_64.py /
v4_mnist_digit_muon_64.py already use for their own no-supplementary-data
...
Output: ./v4_mnist_letter_lc_adamw_64/  (created next to this script)
"""
