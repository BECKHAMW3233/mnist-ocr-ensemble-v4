...
blocks. Same architecture and hyperparameters as v4_mnist_digit_adamw_32.py
...
already returns — the same pattern v4_mnist_digit_soap_32.py /
v4_mnist_digit_muon_32.py already use for their own no-supplementary-data
...
Output: ./v4_mnist_letter_lc_adamw_32/  (created next to this script)
"""
