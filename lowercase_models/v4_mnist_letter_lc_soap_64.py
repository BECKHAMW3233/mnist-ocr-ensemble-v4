...
v4_mnist_digit_soap_64.py (the digit ensemble), retargeted at a 26-class
...
Identical hyperparameters to v4_mnist_digit_soap_64.py:
...
Output: ./v4_mnist_letter_lc_soap_64/  (created next to this script)
"""
