...
original "implemented directly here" design, matching v4_mnist_digit_muon_64.py's
own convention; see v3_CHANGELOG.md's 2026-07-27 and 2026-08-08 entries
for both sides of that history). Identical hyperparameters to v4_mnist_digit_muon_64.py —
see that file's own
...
#     was previously implemented directly in this file, matching v4_mnist_digit_muon_64.py
