...
v4_mnist_digit_muon_64.py (the digit ensemble), retargeted at a 26-class
...
implementation). Identical hyperparameters to v4_mnist_digit_muon_64.py:
...
Output: ./v4_mnist_letter_lc_muon_64/  (created next to this script)
"""
